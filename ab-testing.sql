...
-- Used the tool from https://thumbtack.github.io/abba/demo/abba.html
-- to compute the p-values for the binary metrics 
-- (30 day order binary and 30 day view binary) 
